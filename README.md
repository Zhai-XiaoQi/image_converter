...
![图片格式转换工具 v1.4.2 界面截图](assets/readme-v1.4.2-interface.png)
...
未安装时，工具仍可正常处理 JPG / PNG / WEBP / BMP / TIFF；HEIC 文件会显示无法预览，并在转换报告中写明原因。v1.4.2 EXE 版已在打包环境安装 `pillow-heif`，可直接读取 HEIC/HEIF。

## 版本备份

- `v1.0.0`、`v1.1.0`、`v1.2.0`、`v1.3.0`、`v1.3.1`、`v1.3.2`、`v1.3.3`、`v1.3.4`、`v1.4.0`、`v1.4.1`、`v1.4.2` 保留为 Git 标签。
- 本地保留源码备份压缩包，例如：`version_backups/image_converter_v1.4.2_source_backup.zip`。
