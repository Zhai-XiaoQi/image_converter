...
![图片格式转换工具 v1.2 界面截图](assets/readme-v1.2-interface.png)
...
- `v1.0.0`、`v1.1.0`、`v1.2.0` 保留为 Git 标签。
- 本地保留源码备份压缩包，例如：`version_backups/image_converter_v1.2.0_source_backup.zip`。
